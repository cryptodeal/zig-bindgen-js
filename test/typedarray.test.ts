...
describe('NAPI - `TypedArray`', () => {
  ...
  test('returns `[]i16` as `Int16Array`', () => {
  ...
  test('returns `[]u16` as `Uint16Array`', () => {
  ...
  test('returns `[]i32` as `Int32Array`', () => {
  ...
  test('returns `[]u32` as `Uint32Array`', () => {
  ...
  test('returns `[]i64` as `BigInt64Array`', () => {
  ...
  test('returns `[]u64` as `BigUint64Array`', () => {
  ...
  test('returns `[]f32` as `Float32Array`', () => {
  ...
  test('returns `[]f64` as `Float64Array`', () => {
